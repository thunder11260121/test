const CACHE='wbgt-tabbar-v4';
const ASSETS=['./','index.html','spots.html','favorites.html','styles.css','weather.js','spots.js','favorites.js','manifest.webmanifest','icon-192.png','icon-512.png'];
